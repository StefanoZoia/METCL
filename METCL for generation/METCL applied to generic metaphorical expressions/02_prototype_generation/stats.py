...
REL_DIR = f'data/relations'

def main():
    with open('data/prototyped.tsv', encoding='utf-8', newline='') as corpusfile:
    ...
    with open('data/cn-represented.tsv', encoding='utf-8', newline='') as corpusfile:
        reader = csv.reader(corpusfile, delimiter='\t', quotechar='"')
        for row in reader:
            with open('data/prototyped.tsv', encoding='utf-8', newline='') as outfile:
